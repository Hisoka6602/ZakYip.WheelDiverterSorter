...
/// <summary>
/// Integration tests for IoDriverConfigController
/// </summary>
public class IoDriverConfigControllerTests : IClassFixture<CustomWebApplicationFactory>
{
    private readonly HttpClient _client;

    public IoDriverConfigControllerTests(CustomWebApplicationFactory factory)
    {
    ...
    [Fact]
    public async Task GetIoDriverConfig_ReturnsJsonContent()
    {
        // Act
        var response = await _client.GetAsync("/api/config/io-driver");
    ...
    [Fact]
    public async Task GetIoDriverConfig_EnumsSerializedAsStrings()
    {
        // Act
        var response = await _client.GetAsync("/api/config/io-driver");
    ...
    [Fact]
    public async Task UpdateIoDriverConfig_AcceptsStringEnumValue()
    {
        ...
        // Act
        var response = await _client.PutAsync("/api/config/io-driver", content);
    ...
    [Fact]
    public async Task UpdateIoDriverConfig_AcceptsNumericEnumValue_ForBackwardCompatibility()
    {
