...
public class PanelButtonStateSimulationTests : IDisposable
{
    ...
    public void Scenario1_DefaultState_AndStartButton()
    {
        ...
        // 断言：初始状态为待机（就绪）
        _stateService.Current.Should().Be(SystemState.Ready);
        ...
        _stateService.Current.Should().Be(SystemState.Running);
    ...
    public void Scenario4_EmergencyStopAndFaultState()
    {
        ...
        _stateService.Current.Should().Be(SystemState.EmergencyStop);
