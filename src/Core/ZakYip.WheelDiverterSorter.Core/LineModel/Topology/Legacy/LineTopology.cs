...
/// </summary>
/// <remarks>
/// <para>【遗留类型】此类型为遗留拓扑实现，建议使用 <see cref="SorterTopology"/> 替代。</para>
/// <para>这是统一的拓扑模型，与厂商实现完全解耦。</para>
/// <para>定义了分拣线的逻辑结构：节点、格口、传感器位置等。</para>
/// </remarks>
[Obsolete("遗留拓扑实现，建议迁移到 LineModel.Topology.SorterTopology，后续版本中将移除")]
