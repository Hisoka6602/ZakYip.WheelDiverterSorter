...
/// 当配置热更新时自动更新缓存。
/// </remarks>
public class CachedDriverConfigurationRepository : IDriverConfigurationRepository
{
    private readonly IDriverConfigurationRepository _innerRepository;
    private readonly IMemoryCache _cache;
    private const string CacheKey = "DriverConfiguration";
    ...
    public CachedDriverConfigurationRepository(
        LiteDbDriverConfigurationRepository innerRepository,
        IMemoryCache cache)
    {
