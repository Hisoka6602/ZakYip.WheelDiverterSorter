...
/// </summary>
/// <remarks>
/// **此控制器已弃用**，其功能已迁移到 PolicyController (`/api/policy/overload`)。
/// 保留此控制器仅用于向后兼容，建议使用新的 `/api/policy/overload` 端点。
/// </remarks>
[ApiController]
[Route("api/config")]
[Produces("application/json")]
[Obsolete("此控制器已弃用，请使用 /api/policy/overload 端点。保留仅用于向后兼容。")]
public class OverloadPolicyController : ControllerBase
{
    ...
    /// <remarks>
    /// **此端点已弃用**，请使用 GET /api/policy/overload
    /// </remarks>
    [HttpGet("overload-policy")]
    [SwaggerOperation(
        Summary = "获取超载策略配置（已弃用）",
        Description = "返回当前系统的超载策略配置。**此端点已弃用，请使用 GET /api/policy/overload**",
    ...
    [Obsolete("请使用 GET /api/policy/overload")]
    ...
    /// <response code="500">服务器内部错误</response>
    /// <remarks>
    /// **此端点已弃用**，请使用 PUT /api/policy/overload
    /// </remarks>
    [HttpPut("overload-policy")]
    [SwaggerOperation(
        Summary = "更新超载策略配置（已弃用）",
        Description = "更新系统超载策略配置。**此端点已弃用，请使用 PUT /api/policy/overload**",
    ...
    [ProducesResponseType(typeof(object), 500)]
    [Obsolete("请使用 PUT /api/policy/overload")]
