...
/// </summary>
/// <remarks>
/// 在程序启动时立即启动传感器检测和分拣编排服务。
/// 
/// **设计原则**：
/// - 传感器和面板IO属于同一性质的监控，都在程序启动时立即生效
/// - 取代之前的 SensorActivationWorker，采用更简洁的实现
/// - 状态拦截在业务逻辑层实现，而非传感器层
/// 
/// **实施要求**：
/// - 使用 ISafeExecutionService 包裹后台任务，符合 copilot-instructions.md 第一节第3条
/// </remarks>
