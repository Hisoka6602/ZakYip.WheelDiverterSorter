...
namespace csLTDMC //ռӦó޸
{

    public struct struct_hs_cmp_info
    {
    double start_pos;   //ԱȽʼλ.
    double interval;    //.
    int count;//
    };
    ...
    public partial class LTDMC
    {
        ...
        //----------------------λ쳣-------------------------------	
        //öȡλE3032߿R3032߿DMC3000/5000/5X10ϵ忨	
        ...
        //IOֹ֧ͣpmove/vmove˶DMC3000DMC5X10ϵ忨
        [DllImport("LTDMC.dll")]
        ...
        //ٶ(嵱)EtherCAT߿RTEX߿DMC5000/5X10ϵ忨	
        ...
        //ٶãٶֵʾ()EtherCAT߿RTEX߿DMC5000/5X10ϵ忨
        ...
        //λ˶()EtherCAT߿RTEX߿DMC5000/5X10ϵ忨
        ...
        //ٱλ()EtherCAT߿RTEX߿DMC5000/5X10ϵ忨
        ...
        //߱()˶иıָĵǰ˶ٶȣEtherCAT߿RTEX߿DMC5000/5X10ϵ忨
        ...
        //岹ٶȲ()EtherCAT߿RTEX߿DMC5000/5X10ϵ忨
        ...
        public static extern short dmc_set_vector_profile_unit(UInt16 CardNo, UInt16 Crd, double Min_Vel, double Max_Vel, double Tacc, double Tdec, double Stop_Vel);   //β岹ٶȲ
        ...
        //ƽٶ߲EtherCAT߿RTEX߿DMC5000/5X10ϵ忨
        ...
        //ֱ߲岹()EtherCAT߿RTEX߿DMC5000/5X10ϵ忨
        ...
        //ԲԲ岹()EtherCAT߿RTEX߿DMC5000/5X10ϵ忨
...
//ԲյʽԲ//
        //뾶Բ岹()EtherCAT߿RTEX߿DMC5000/5X10ϵ忨
...
//뾶յʽԲ/
        //Բ岹()EtherCAT߿RTEX߿DMC5000/5X10ϵ忨
        ...
        //β岹()EtherCAT߿RTEX߿DMC5000/5X10ϵ忨
...
//岹β岹ָ
        ...
        //棨Ԥ
        [DllImport("LTDMC.dll")]
        public static extern short dmc_get_latch_value_extern_unit(UInt16 CardNo, UInt16 axis, UInt16 index, ref double pos_by_mm);//ȡֵȡ 
        //ȡDMC3000ϵ忨
        ...
        //----------------------- п---------------------------------
        //ģʽ0-棬1-棻0-½أ1-أ2-˫أ˲ʱ䣬λusDMC5X10/3000ϵ忨߿
        [DllImport("LTDMC.dll")]
        ...
        //ȡٱȽ״̬DMC5X10ϵ忨E5032߿
        [DllImport("LTDMC.dll")]
        public static extern short dmc_hcmp_get_current_state_unit(UInt16 CardNo, UInt16 hcmp, ref Int32 remained_points, ref double current_point, ref Int32 runned_points); //ȡٱȽ״̬
        //Ƚϵ㣨忨߿
...
current_state, ref UInt16 current_outbit); 
        ...
        public static extern short dmc_set_encoder_unit(UInt16 CardNo, UInt16 axis, double pos);     //ǰλ
        ...
        public static extern short dmc_set_position_unit(UInt16 CardNo, UInt16 axis, double pos);   //ǰָλ
        ...
        public static extern short dmc_read_current_speed_unit(UInt16 CardNo, UInt16 Axis, ref double current_speed);   //ᵱǰٶ
        //ȡǰĲ岹ٶȣDMC5X10ϵ忨߿
        [DllImport("LTDMC.dll")]
        public static extern short dmc_read_vector_speed_unit(UInt16 CardNo, UInt16 Crd, ref double current_speed);	//ȡǰĲ岹ٶ
        //ȡָĿλã忨R3032߿
        ...
        public static extern short dmc_calculate_arclength_center(double[] start_pos, double[] target_pos, double[] cen_pos, UInt16 arc_dir, double circle, ref double ArcLength);      //ԲԲ
        ...
        //岹˶״̬0-У1-ͣ2-ֹͣDMC5X10֧֣3-δ4-УDMC5000/5X10ϵ忨E5032߿
        ...
        public static extern short dmc_conti_set_pause_output(UInt16 CardNo, UInt16 Crd, UInt16 action, Int32 mask, Int32 state);     //ͣʱIO action 0, 1 ͣʱio_state; 2 ͣʱio_state,ʱȻָԭio; 3,2ĻϣֹͣʱҲЧ
...
mark);   
        ...
        public static extern short dmc_conti_get_involute_mode(UInt16 CardNo, UInt16 Crd, ref UInt16 mode);   //ȡǷ
        //ã
        [DllImport("LTDMC.dll")]
...
stop_mode );
        ...
        public static extern short nmc_download_configfile(UInt16 CardNo, UInt16 PortNum, String FileName);//ENIļ
...
stop_vel2, double acc_time, double dec_time, UInt16 posi_mode);
        //
        [DllImport("LTDMC.dll")]
        public static extern short dmc_compare_add_point_XD(UInt16 CardNo, UInt16 cmp, long pos, UInt16 dir, UInt16 action, UInt32 actpara, long startPos);//綨ƱȽϺ
        
        //---------------------------ORG봥߱ٱλ----------------------
        //ORG봥߱ٱλDMC3000/5X10ϵ忨
        [DllImport("LTDMC.dll")]
        ...
        //ȡORG봥߱ٱλ״̬  trig_num trig_pos λãDMC3000/5X10ϵ忨
        [DllImport("LTDMC.dll")]
        ...
        //20190923޸kgƺӿڣͻƣ
        [DllImport("LTDMC.dll")]
        public static extern short dmc_read_inbit_append(UInt16 CardNo, UInt16 bitno);//ȡڵ״̬
        [DllImport("LTDMC.dll")]
        public static extern short dmc_write_outbit_append(UInt16 CardNo, UInt16 bitno, UInt16 on_off);//ڵ״̬
        [DllImport("LTDMC.dll")]
        public static extern short dmc_read_outbit_append(UInt16 CardNo, UInt16 bitno);//ȡڵ״̬
        [DllImport("LTDMC.dll")]
        public static extern UInt32 dmc_read_inport_append(UInt16 CardNo, UInt16 portno);//ȡ˿ڵֵ
        [DllImport("LTDMC.dll")]
        public static extern UInt32 dmc_read_outport_append(UInt16 CardNo, UInt16 portno);//ȡ˿ڵֵ
        [DllImport("LTDMC.dll")]
        public static extern short dmc_write_outport_append(UInt16 CardNo, UInt16 portno, UInt32 port_value);//˿ڵֵ
...
trigPosType, ushort[] trigMode, uint mark);//λôƶ
        [DllImport("LTDMC.dll")]
...
ushort trigAxisNum, ushort[] trigAxisList, double[] trigPos, ushort[] trigPosType, ushort[] trigMode, uint mark);//λôƶ
        [DllImport("LTDMC.dll")]
...
ushort trigMode, ushort TrigINNum, ushort[] trigINList, ushort[] trigINstate, uint mark);//λ+ioƶ
        [DllImport("LTDMC.dll")]
...
ushort trigMode, uint mark);//λôƶ
 ...
 process_mode, ushort trigAxis, double trigPos, ushort trigPosType, ushort trigMode, uint mark);//λôƶ
        [DllImport("LTDMC.dll")]
...
[] trigAxisList, double[] trigPos, ushort[] trigPosType, ushort[] trigMode, uint mark);
        [DllImport("LTDMC.dll")]
        public static extern short dmc_m_posTrig_outbit(ushort card, ushort group, ushort bitno, ushort on_off, ushort ahead_axis, double ahead_value, ushort ahead_PosType, ushort ahead_Mode, uint mark);//λôIO
        [DllImport("LTDMC.dll")]
...
Pos_Mode,long mark);
        ...
        //TypeIndex:0~6  m_Averagetime ; ƽʱ m_Maxtime;ʱ uint64  m_Cycles;ǰʱ
        [DllImport("LTDMC.dll")]
        ...
        [DllImport("LTDMC.dll")]
        public static extern short dmc_rtcp_set_workpiece_mode(ushort CardNo, ushort Crd, ushort enable, ushort workpiece_index);    //ϵ0-3ʹĸϵ
        [DllImport("LTDMC.dll")]
        public static extern short dmc_rtcp_get_workpiece_mode(ushort CardNo, ushort Crd,ref ushort enable,ref ushort workpiece_index);    //ϵ0-3ʹĸϵ
...
ushort trigPosType, ushort trigMode, UInt32 mark);//λôתƶ
...
double slave_sync_pos,ref double master_start_dist,ref double velocity,ref double acc,ref double dec,ref double s_time,ref ushort buffer_mode);
        ...
        /***********************************************************
             * òɼһο500ɼ
             * data_type 	ݵͣɼ˵
             * data_index 	ݵǸأţIOIOţ
             * data_sub_index ݵǰɼIOʾIOš
             * data_bytes 	ֽвɼͻԶƥ䣬̶Ϊ0Ԥչ
        **********************************************************/
        [DllImport("LTDMC.dll")]
...
offset);
	   ...
	   [DllImport("LTDMC.dll")]
        ...
        {
            public float fl_val;//pwm涯ֵ
            public float ctrl_val;//ֵԱ
        }
        public struct DaCurve_CtrlPoint
        {
            public float vol_val;//daֵ
            public float ctrl_val;//ֵԱ
        }
        //5X10ϵ岹DA--T/P
        [DllImport("LTDMC.dll")]
